...
const STANDARD_SEAMS = [
  ...
  { name: 'Double Fold Hem', type: 'Hem', svg: svgToDataUri('<svg viewBox="0 0 200 100" xmlns="http://www.w3.org/2000/svg"><path d="M 20,30 L 160,30 A 10,10 0 0 1 170,40 A 10,10 0 0 1 160,50 L 110,50 A 10,10 0 0 0 100,60 A 10,10 0 0 0 110,70 L 140,70" fill="none" stroke="#1f2937" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" /><line x1="125" y1="20" x2="125" y2="80" stroke="#ef4444" stroke-width="3" stroke-dasharray="5,4" /></svg>') },
  { name: 'Blind Hem', type: 'Hem', svg: svgToDataUri('<svg viewBox="0 0 200 100" xmlns="http://www.w3.org/2000/svg"><path d="M 20,30 L 140,30 A 10,10 0 0 1 150,40 A 10,10 0 0 1 140,50 L 90,50 A 10,10 0 0 0 80,60 A 10,10 0 0 0 90,70 L 170,70" fill="none" stroke="#1f2937" stroke-width="3" /><path d="M 120,40 L 90,60 L 120,80" fill="none" stroke="#ef4444" stroke-width="3" stroke-dasharray="3,3" /></svg>') },
  { name: 'Rolled / Merrow Hem', type: 'Hem', svg: svgToDataUri('<svg viewBox="0 0 200 100" xmlns="http://www.w3.org/2000/svg"><path d="M 20,50 L 140,50 A 10,10 0 0 1 150,60 A 10,10 0 0 1 140,70 A 5,5 0 0 1 135,65 A 5,5 0 0 1 140,60" fill="none" stroke="#1f2937" stroke-width="3" /><circle cx="145" cy="60" r="12" fill="none" stroke="#ef4444" stroke-width="2" stroke-dasharray="2,2" /></svg>') },
  { name: 'Single Fold Hem', type: 'Hem', svg: svgToDataUri('<svg viewBox="0 0 200 100" xmlns="http://www.w3.org/2000/svg"><path d="M 20,30 L 160,30 A 10,10 0 0 1 170,40 A 10,10 0 0 1 160,50 L 100,50" fill="none" stroke="#1f2937" stroke-width="3" /><path d="M 95,45 L 105,45 L 105,55 L 95,55 Z" fill="none" stroke="#1f2937" stroke-width="1" /><line x1="120" y1="20" x2="120" y2="60" stroke="#ef4444" stroke-width="3" stroke-dasharray="5,4" /></svg>') },

  // Seams
  { name: 'Overlock / Serged', type: 'Seam', svg: svgToDataUri('<svg viewBox="0 0 200 100" xmlns="http://www.w3.org/2000/svg"><line x1="20" y1="45" x2="150" y2="45" stroke="#1f2937" stroke-width="3" /><line x1="20" y1="55" x2="150" y2="55" stroke="#1f2937" stroke-width="3" /><path d="M 130,35 L 160,35 L 160,65 L 130,65 Z" fill="none" stroke="#ef4444" stroke-width="2" /><path d="M 135,35 L 160,45 L 135,55 L 160,65" fill="none" stroke="#ef4444" stroke-width="2" /><line x1="140" y1="30" x2="140" y2="70" stroke="#ef4444" stroke-width="3" stroke-dasharray="5,4" /></svg>') },
  { name: 'Safety Stitch (5-Thread)', type: 'Seam', svg: svgToDataUri('<svg viewBox="0 0 200 100" xmlns="http://www.w3.org/2000/svg"><line x1="20" y1="45" x2="150" y2="45" stroke="#1f2937" stroke-width="3" /><line x1="20" y1="55" x2="150" y2="55" stroke="#1f2937" stroke-width="3" /><path d="M 140,35 L 160,35 L 160,65 L 140,65 Z" fill="none" stroke="#ef4444" stroke-width="2" /><line x1="120" y1="30" x2="120" y2="70" stroke="#ef4444" stroke-width="3" stroke-dasharray="5,4" /><line x1="145" y1="30" x2="145" y2="70" stroke="#ef4444" stroke-width="2" stroke-dasharray="3,2" /></svg>') },
  { name: 'Flat Felled Seam', type: 'Seam', svg: svgToDataUri('<svg viewBox="0 0 200 100" xmlns="http://www.w3.org/2000/svg"><path d="M 20,60 L 120,60 A 10,10 0 0 0 130,50 A 10,10 0 0 0 120,40 L 80,40 A 10,10 0 0 1 70,30 L 70,20 L 20,20" fill="none" stroke="#1f2937" stroke-width="3" /><path d="M 180,40 L 80,40 A 10,10 0 0 0 70,50 A 10,10 0 0 0 80,60 L 120,60 A 10,10 0 0 1 130,70 L 130,80 L 180,80" fill="none" stroke="#1f2937" stroke-width="3" /><line x1="90" y1="30" x2="90" y2="70" stroke="#ef4444" stroke-width="3" stroke-dasharray="5,4" /><line x1="110" y1="30" x2="110" y2="70" stroke="#ef4444" stroke-width="3" stroke-dasharray="5,4" /></svg>') },
  { name: 'French Seam', type: 'Seam', svg: svgToDataUri('<svg viewBox="0 0 200 100" xmlns="http://www.w3.org/2000/svg"><path d="M 20,30 L 140,30 A 10,10 0 0 1 150,40 L 150,50 L 90,50 A 10,10 0 0 0 80,60 L 80,80 L 20,80" fill="none" stroke="#1f2937" stroke-width="3" /><path d="M 20,40 L 130,40 A 10,10 0 0 0 140,50 L 140,60 L 90,60 A 10,10 0 0 1 80,70 L 80,90 L 20,90" fill="none" stroke="#1f2937" stroke-width="3" /><line x1="105" y1="20" x2="105" y2="70" stroke="#ef4444" stroke-width="3" stroke-dasharray="5,4" /></svg>') },
  { name: 'Mock French Seam', type: 'Seam', svg: svgToDataUri('<svg viewBox="0 0 200 100" xmlns="http://www.w3.org/2000/svg"><path d="M 20,30 L 120,30 A 10,10 0 0 1 130,40 A 10,10 0 0 1 120,50 L 90,50" fill="none" stroke="#1f2937" stroke-width="3" /><path d="M 20,70 L 120,70 A 10,10 0 0 0 130,60 A 10,10 0 0 0 120,50 L 90,50" fill="none" stroke="#1f2937" stroke-width="3" /><line x1="100" y1="20" x2="100" y2="80" stroke="#ef4444" stroke-width="3" stroke-dasharray="5,4" /></svg>') },
  { name: 'Bound Seam', type: 'Seam', svg: svgToDataUri('<svg viewBox="0 0 200 100" xmlns="http://www.w3.org/2000/svg"><line x1="20" y1="50" x2="140" y2="50" stroke="#1f2937" stroke-width="3" /><path d="M 110,30 L 150,30 A 10,10 0 0 1 160,40 L 160,60 A 10,10 0 0 1 150,70 L 110,70 A 10,10 0 0 1 100,60 A 10,10 0 0 1 110,50 L 140,50" fill="none" stroke="#1f2937" stroke-width="3" /><path d="M 140,50 L 110,50 A 10,10 0 0 0 100,40 A 10,10 0 0 0 110,30" fill="none" stroke="#1f2937" stroke-width="3" /><line x1="120" y1="20" x2="120" y2="80" stroke="#ef4444" stroke-width="3" stroke-dasharray="5,4" /></svg>') },
  { name: 'Lapped Seam', type: 'Seam', svg: svgToDataUri('<svg viewBox="0 0 200 100" xmlns="http://www.w3.org/2000/svg"><path d="M 20,40 L 140,40" stroke="#1f2937" stroke-width="3" /><path d="M 60,60 L 180,60" stroke="#1f2937" stroke-width="3" /><line x1="80" y1="30" x2="80" y2="70" stroke="#ef4444" stroke-width="3" stroke-dasharray="5,4" /><line x1="120" y1="30" x2="120" y2="70" stroke="#ef4444" stroke-width="3" stroke-dasharray="5,4" /></svg>') },
  { name: 'Flatlock Seam', type: 'Seam', svg: svgToDataUri('<svg viewBox="0 0 200 100" xmlns="http://www.w3.org/2000/svg"><path d="M 20,50 L 95,50" stroke="#1f2937" stroke-width="3" /><path d="M 105,50 L 180,50" stroke="#1f2937" stroke-width="3" /><path d="M 70,40 L 130,40 L 130,60 L 70,60 Z" fill="none" stroke="#ef4444" stroke-width="2" stroke-dasharray="4,2" /></svg>') },

  // Stitches
  { name: 'Edge Stitch', type: 'Stitch', svg: svgToDataUri('<svg viewBox="0 0 200 100" xmlns="http://www.w3.org/2000/svg"><path d="M 20,40 L 160,40 A 10,10 0 0 1 170,50 A 10,10 0 0 1 160,60 L 20,60" fill="none" stroke="#1f2937" stroke-width="3" /><line x1="150" y1="30" x2="150" y2="70" stroke="#ef4444" stroke-width="3" stroke-dasharray="5,4" /></svg>') },
  { name: 'Single Needle Topstitch', type: 'Stitch', svg: svgToDataUri('<svg viewBox="0 0 200 100" xmlns="http://www.w3.org/2000/svg"><line x1="20" y1="50" x2="180" y2="50" stroke="#1f2937" stroke-width="3" /><line x1="100" y1="35" x2="100" y2="65" stroke="#ef4444" stroke-width="3" stroke-dasharray="5,4" /></svg>') },
  { name: 'Double Needle Topstitch', type: 'Stitch', svg: svgToDataUri('<svg viewBox="0 0 200 100" xmlns="http://www.w3.org/2000/svg"><line x1="20" y1="50" x2="180" y2="50" stroke="#1f2937" stroke-width="3" /><line x1="90" y1="35" x2="90" y2="65" stroke="#ef4444" stroke-width="3" stroke-dasharray="5,4" /><line x1="110" y1="35" x2="110" y2="65" stroke="#ef4444" stroke-width="3" stroke-dasharray="5,4" /></svg>') },
  { name: 'Bar Tack', type: 'Stitch', svg: svgToDataUri('<svg viewBox="0 0 200 100" xmlns="http://www.w3.org/2000/svg"><line x1="20" y1="50" x2="180" y2="50" stroke="#1f2937" stroke-width="3" /><path d="M 80,42 L 85,58 L 90,42 L 95,58 L 100,42 L 105,58 L 110,42 L 115,58 L 120,42 L 125,58 L 130,42" fill="none" stroke="#ef4444" stroke-width="3" stroke-linejoin="round" /></svg>') },
];

const GROUPED_SEAMS = {
  'Hems': STANDARD_SEAMS.filter(s => s.type === 'Hem'),
  'Seams': STANDARD_SEAMS.filter(s => s.type === 'Seam'),
...
export function TechPackEditor() {
  ...
  const moveMeasurement = (fromIndex: number, toIndex: number) => {
    ...
    if (
      fromIndex < 0 || 
      fromIndex >= currentMeasurements.length || 
      toIndex < 0 || 
      toIndex >= currentMeasurements.length ||
      fromIndex === toIndex
    ) {
      return;
    }

    const [moved] = currentMeasurements.splice(fromIndex, 1);
    currentMeasurements.splice(toIndex, 0, moved);
                ...
                <div className="overflow-x-auto rounded-xl border border-gray-200 bg-white shadow-sm max-w-full">
                  <table className="w-full text-xs print:text-[10px] text-left min-w-[500px]">
                    <thead className="text-xs print:text-[10px] text-gray-500 uppercase bg-gray-50 border-b border-gray-200">
                      <tr>
                        {!isTechPackLocked && <th className="w-7 px-1 py-1 text-center font-medium text-gray-400 print:hidden" title="Drag to reorder"></th>}
                        ...
                        <th className="px-1 py-1 font-medium w-12 text-center">Tol (+)</th>
                        {!isTechPackLocked && <th className="w-20 px-1 py-1 text-center font-medium text-gray-400 print:hidden">Actions</th>}
                      </tr>
                    </thead>
                    <tbody>
                      {(displayData.measurements || []).map((m: any, i: number) => {
                        const isDragging = draggedMeasurementIdx === i;
                        const isDragOver = dragOverMeasurementIdx === i && draggedMeasurementIdx !== i;
                        ...
                        return (
                          <tr 
                            ...
                            onDragStart={(e) => {
                              ...
                              e.dataTransfer.effectAllowed = 'move';
                              setDraggedMeasurementIdx(i);
                            }}
                            onDragOver={(e) => {
                              if (isTechPackLocked || checkReadonly()) return;
                              e.preventDefault();
                              e.dataTransfer.dropEffect = 'move';
                              if (dragOverMeasurementIdx !== i) {
                                setDragOverMeasurementIdx(i);
                              }
                            }}
                            onDragLeave={() => {
                              if (dragOverMeasurementIdx === i) {
                            ...
                            onDrop={(e) => {
                              ...
                              const fromIdx = fromStr !== '' ? parseInt(fromStr, 10) : draggedMeasurementIdx;
                              setDragOverMeasurementIdx(null);
                              setDraggedMeasurementIdx(null);
                              if (fromIdx !== null && !isNaN(fromIdx) && fromIdx !== i) {
                                moveMeasurement(fromIdx, i);
                              }
                            }}
                            onDragEnd={() => {
                              setDragOverMeasurementIdx(null);
                          ...
                          >
                            {!isTechPackLocked && (
                              <td className="px-1 py-2 align-middle text-center print:hidden w-7 cursor-grab active:cursor-grabbing">
                                <div 
                                  className="flex items-center justify-center text-gray-300 group-hover/row:text-gray-600 hover:bg-gray-200/60 p-0.5 rounded transition-colors"
                                  title="Drag to reorder measurement"
                                >
                            ...
                            {!isTechPackLocked && (
                              <td className="px-1 py-2 align-middle text-center print:hidden w-20">
                                <div className="flex items-center justify-center gap-0.5 opacity-60 group-hover/row:opacity-100 transition-opacity">
                                  <button
                                    type="button"
                                    disabled={i === 0}
                                    onClick={() => moveMeasurement(i, i - 1)}
                                    ...
                                    title="Move up"
                                    aria-label="Move measurement up"
                                  >
                                    <ArrowUp size={13} />
                                  </button>
                                  <button
                                    type="button"
                                    disabled={i === (displayData.measurements || []).length - 1}
                                    onClick={() => moveMeasurement(i, i + 1)}
                                    className="text-gray-400 hover:text-gray-900 disabled:opacity-20 disabled:hover:text-gray-400 p-1 rounded hover:bg-gray-100 transition-all cursor-pointer disabled:cursor-not-allowed"
                                    title="Move down"
                                    aria-label="Move measurement down"
                                  >
                                    <ArrowDown size={13} />
                                  </button>
                                  <button
                                    ...
                                    className="text-gray-400 hover:text-red-600 hover:bg-red-50 p-1 rounded transition-all cursor-pointer inline-flex items-center justify-center group-hover/row:text-red-500 ml-0.5"
                      ...
                      {(displayData.measurements || []).length === 0 && (
                        <tr>
                          <td colSpan={!isTechPackLocked ? 7 : 5} className="py-8 text-center text-gray-400 italic text-xs">
                           ...
                           <div className="flex-1 relative space-y-2">
                              ...
                              <div className="flex items-center gap-2 print:hidden">
                                ...
                                >
                                  ...
                                  {Object.entries(GROUPED_SEAMS).map(([group, items]) => (
