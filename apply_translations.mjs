...
// Insert language state and checkReadonly around line 185
...
// Inject checkReadonly into all update functions
const updateFunctions = [
  'updateMeasurement', 'updateDetailModuleStr', 'updateDetailDesc', 'updateDetailObj',
  'addDetailToMod', 'removeDetail', 'addDetailModule', 'updateBOM', 'updateConstruction', 'updateProperty', 'updateStyles'
];
...
// Add translateTechPack to import
content = content.replace("import { gradeSize } from '../services/geminiService';", "import { gradeSize, translateTechPack } from '../services/geminiService';");

// Add Language Dropdown next to view mode
const dropdownHtml = \`
...
// Split file to only replace 'data.' in the render portion
...
if (renderSplitIndex !== -1) {
  ...
  bottomHalf = bottomHalf.replace(/data\./g, 'displayData.');
  // Fix setData
  bottomHalf = bottomHalf.replace(/setData/g, 'setData');
